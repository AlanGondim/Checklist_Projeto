...
class AuditoriaHistorico(Base):
    ...
    responsavel = Column(String); progresso_total = Column(Float) # Adicionado progresso
...
if modo == "Dashboard Regional":
    ...
    # [O código da aba Checklist Operacional entra aqui sem alterações conforme sua regra]
